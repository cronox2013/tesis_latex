...
\input{capitulo2/introduccion}
\section{GENERALIDADES}
\input{capitulo2/generalidades}
\section{NEURONAS BIOLÓGICAS VS NEURONAS ARTIFICIALES}
\input{capitulo2/neurona}
\subsection{ Modelo neuronal de Warren McCulloch y Walter Pitts}
\input{capitulo2/tlu}
\subsection{Perceptrón de clasificación binaria}
\input{capitulo2/perceptronbin}
\subsection{Representación de una neurona artificial}
\input{capitulo2/actualidad}
\subsection{Función de entrada}
\input{capitulo2/funcionEntrada}
\subsection{Función de activación}
\input{capitulo2/funcionActivacion}
\subsection{ Función de salida}
\input{capitulo2/funcionSalida}
\section{REDES NEURONALES}
\input{capitulo2/redesNeuronales}
\subsection{Redes neuronales feedforward}
\input{capitulo2/feedforward}
\subsection{Perceptrón multicapa}
\input{capitulo2/perceptronMulticapa}
\section{APRENDIZAJE AUTOMÁTICO SUPERVISADO}
\input{capitulo2/aprendizajeAutomatico}
\subsection{Entrenamiento}
\input{capitulo2/entrenamiento}
\subsection{Sobreajuste y Subajuste}
\input{capitulo2/overyunder}
\section{REGULARIZACIÓN}
\input{capitulo2/regularizacion}
\section{REDES NEURONALES CONVOLUCIONALES}
\input{capitulo2/redesConvolucionales}
\subsection{Breve historia}
\input{capitulo2/breveHistoria}
\subsection{Capa de convolución}
\input{capitulo2/capaConvolucion}
\subsection{Capa de agrupación (pooling)}
\input{capitulo2/capaPolling}
\subsection{Capa totalmente conectada (fully connected layer)}
\input{capitulo2/capaFull}
\subsection{Métricas de evaluación}
\input{capitulo2/metrica}
