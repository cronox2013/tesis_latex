...
\lstinputlisting[language=Python,firstline=11,caption=Codigo fuente del archivo bert\_multi.py
\\\textit{Fuente: Elaboración Propia},label={lst:c5}]{capitulo5/codigo/bert_multi.py}
...
\lstinputlisting[language=Python,firstline=7,caption=Codigo fuente del archivo operacion\_dataset.py
\\\textit{Fuente: Elaboración Propia},label={lst:c6}]{capitulo5/codigo/operacion_dataset.py}
