...
\lstinputlisting[language=Python,firstline=7,caption=Codigo fuente visualizacion estado del conjunto de datos,label={lst:c5}]{capitulo5/codigo/creando_dataset.py}
...
\lstinputlisting[language=Python,firstline=7,caption=Codigo fuente preparacion entrada final,label={lst:c6}]{capitulo5/codigo/preparar_datos.py}
...
\lstinputlisting[language=Python,firstline=7,caption=Codigo fuente preparacion entrada final,label={lst:c7}]{capitulo5/codigo/cnn_tres.py}
...
\lstinputlisting[language=Python,firstline=7,caption=Codigo fuente preparacion entrada final,label={lst:c8}]{capitulo5/codigo/cnn_cuatro.py}
