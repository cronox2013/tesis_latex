...
\lstinputlisting[language=Python,firstline=7,caption=Codigo fuente del archivo limpiar\_datos.py
\\\textit{Fuente: Elaboracion Propia},label={lst:c1}]{capitulo5/codigo/limpiar_datos.py}
...
\lstinputlisting[language=Python,firstline=7,caption=Codigo fuente del archivo manejo\_archivos.py
\\\textit{Fuente: Elaboracion Propia},label={lst:c3}]{capitulo5/codigo/manejo_archivos.py}
...
\lstinputlisting[language=Python,firstline=8,caption=Codigo fuente del archivo convertir\_formato.py
\\\textit{Fuente: Elaboracion Propia},label={lst:c4}]{capitulo5/codigo/convertir_formato.py}