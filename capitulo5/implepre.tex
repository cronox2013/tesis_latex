...
\lstinputlisting[language=Python,firstline=7,caption=Codigo fuente del archivo corrector\_lenguaje.py
\\\textit{Fuente: Elaboración Propia},label={lst:c2}]{capitulo5/codigo/corrector_lenguaje.py}
